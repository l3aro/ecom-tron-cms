...
<section id="main-content">
	<section class="wrapper">
        ...
        @endif
        <form method="post" action="/admin/product-cat/detail?id={{ isset($category)?$category->id:'' }}" enctype="multipart/form-data">
            {{ csrf_field() }}
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">ID is the code of the category, this is a unique property</small>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group text-center">
                            ...
                            <img src="{{ isset($category->image)?URL::asset('media/product-cat/'.$category->image):'' }}" width="auto" height="300"/>
