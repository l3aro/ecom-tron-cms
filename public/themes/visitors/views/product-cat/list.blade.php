    ...
    <table class="table table-striped b-t b-light">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{!! $value->id !!}</td>
                <td>
                    <a href="/admin/product-cat/detail?id={{$value->id}}">
                        {!! $value->name !!}
                    </a>
                </td>
                <td>
                ...
                <td>
                    <a href="/admin/product-cat/detail?parent={{$value->id}}" class="active" ui-toggle-class="" data-toggle="tooltip" data-placement="top" title="Add sub category">
